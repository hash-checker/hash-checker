...
public class JdkHashCalculatorTest {
    ...
    @Test
    public void sha1FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
    ...
    @Test
    public void sha224FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
    ...
    @Test
    public void sha256FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
    ...
    @Test
    public void sha384FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
    ...
    @Test
    public void sha512FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
    ...
    @Test
    public void crc32FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
                "784dd132",
    ...
    @Test
    public void sha3224FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
    ...
    @Test
    public void sha3256FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
    ...
    @Test
    public void sha3384FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(
    ...
    @Test
    public void sha3512FromString() throws NoSuchAlgorithmException, NoSuchProviderException {
        assertEquals(

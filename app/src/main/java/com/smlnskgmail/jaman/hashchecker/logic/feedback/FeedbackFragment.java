...
public class FeedbackFragment extends BaseFragment {
    ...
    public void initializeContent(@NonNull final View contentView) {
        ...
        applyInfoToTextView(contentView, R.id.tv_hash_checker_value, feedback.getAppInfo());
        applyInfoToTextView(contentView, R.id.tv_android_value, feedback.getOsVersion());
        applyInfoToTextView(contentView, R.id.tv_manufacturer_value, feedback.getManufacturer());
        applyInfoToTextView(contentView, R.id.tv_model_value, feedback.getModel());
    }

    private void applyInfoToTextView(@NonNull View contentView, int textViewResId, @NonNull String info) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            sendEmail(feedback.getFeedback(feedbackEdit.getText().toString()), getString(R.string.common_email));
        }
